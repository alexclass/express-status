...
[![Build Status](https://travis-ci.org/RiptideButt/express-status.svg)](https://travis-ci.org/RiptideButt/express-status)
[![Coverage Status](https://coveralls.io/repos/RiptideButt/express-status/badge.svg?branch=master)](https://coveralls.io/r/RiptideButt/express-status?branch=master)
## Purpose
...
## Document
Documentation is managed by commenting code with [jsdoc](http://usejsdoc.org/) and editing the [template](https://github.com/RiptideButt/express-status/blob/master/docjs2md/README.hbs).
You can regenerate the [README.md](https://github.com/RiptideButt/express-status/blob/master/README.md) by executing
```bash
gulp doc
```
